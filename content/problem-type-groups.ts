...
export const problemTypeGroups: ProblemTypeGroup[] = [
  { id: 'implementation', title: 'Пряма реалізація та обробка даних', description: 'Симуляція, індекси, порядок дій і базові контейнери.', chapterIds: ['ch-06', 'ch-07', 'ch-12'] },
  ...
  { id: 'optimization', title: 'Мінімум, максимум та оптимізація', description: 'Пошук найкращого значення або структури.', chapterIds: ['ch-10', 'ch-11', 'ch-12', 'ch-16', 'ch-24'] },
  ...
  { id: 'hidden', title: 'Алгоритм не видно', description: 'Аналіз обмежень, доведення й переформулювання.', chapterIds: ['ch-12', 'ch-26'] },
];
