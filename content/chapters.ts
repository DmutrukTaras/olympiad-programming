...
export const chapters: Chapter[] = [
  ...
  chapter('ch-02', 'constraints-complexity', 2, 'Constraints і оцінка складності', 'Перекладаємо обмеження на допустиму асимптотику.', 'foundation', ['оцінка складності'], { prerequisiteIds: ['ch-01'] }),
  chapter('ch-03', 'brute-force-to-efficient', 3, 'Від brute force до ефективного алгоритму', 'Будуємо просте рішення та знаходимо зайву роботу.', 'foundation', ['оптимізація', 'повний перебір'], { prerequisiteIds: ['ch-02'] }),
  chapter('ch-04', 'recognize-pattern', 4, 'Як розпізнати патерн і перевірити рішення', 'Формуємо гіпотезу, доведення та набір перевірок.', 'foundation', ['розпізнавання патернів'], { prerequisiteIds: ['ch-01', 'ch-02'] }),
